...
class Git(VersionControl):
    ...
    def get_url(self, location):
        ...
        remotes = self.run_command(["config", "--get-regexp", r"remote\..*\.url"], show_stdout=False, cwd=location)
    ...
    def get_revision(self, location, rev=None):
        if rev is None:
            rev = "HEAD"
        current_rev = self.run_command(["rev-parse", rev], show_stdout=False, cwd=location)
    ...
    def get_src_requirement(self, dist, location):
        ...
        req = make_vcs_requirement_url(repo, current_rev, egg_project_name, subdir=subdir)
