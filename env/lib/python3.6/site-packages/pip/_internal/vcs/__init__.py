...
from pip._internal.utils.misc import display_path, backup_dir, call_subprocess, rmtree, ask_path_exists
    ...
    def run_command(
        ...
        try:
            ...
            if e.errno == errno.ENOENT:
                raise BadCommand(
                    "Cannot find command %r - do you have " "%r installed and in your " "PATH?" % (self.name, self.name)
                )
            else:
