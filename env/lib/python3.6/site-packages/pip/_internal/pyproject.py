...
def load_pyproject_toml(use_pep517, pyproject_toml, setup_py, req_name):
    ...
    if build_system is None:
        ...
        build_system = {"requires": ["setuptools>=38.2.5", "wheel"], "build-backend": "setuptools.build_meta"}
    ...
    if not _is_list_of_str(requires):
        raise InstallationError(
            error_template.format(package=req_name, reason="'build-system.requires' is not a list of strings.")
        )
