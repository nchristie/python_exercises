        ...
        if self.download_dir:
            ...
            if os.path.exists(self.download_dir):
                ...
                raise InstallationError(
                    "Could not find or access download directory '%s'" % display_path(self.download_dir)
                )
        return False
    ...
    def prepare_linked_requirement(self, req, session, finder, upgrade_allowed, require_hashes):
        ...
        with indent_log():
            ...
            try:
                ...
                raise InstallationError(
                    "Could not install requirement %s because of HTTP " "error %s for URL %s" % (req, exc, req.link)
                )
