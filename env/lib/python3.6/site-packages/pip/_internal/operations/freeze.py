...
from pip._internal.utils.misc import dist_is_editable, get_installed_distributions, make_vcs_requirement_url
                ...
                for line in req_file:
                    ...
                    if line.startswith("-e") or line.startswith("--editable"):
                        ...
                        line_req = install_req_from_line(
                            COMMENT_RE.sub("", line).strip(), isolated=isolated, wheel_cache=wheel_cache
                        )
