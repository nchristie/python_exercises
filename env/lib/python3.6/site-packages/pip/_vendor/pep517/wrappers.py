...
class Pep517HookCaller(object):
    ...
    def build_sdist(self, sdist_directory, config_settings=None):
        ...
        """
        return self._call_hook(
            "build_sdist", {"sdist_directory": abspath(sdist_directory), "config_settings": config_settings}
        )
    ...
    def _call_hook(self, hook_name, kwargs):
        ...
        with tempdir() as td:
            ...
            check_call([sys.executable, _in_proc_script, hook_name, td], cwd=self.source_dir, env=env)
