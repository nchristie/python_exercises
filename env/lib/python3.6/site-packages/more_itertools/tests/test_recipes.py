...
class GrouperTests(TestCase):
    ...
    def test_even(self):
        ...
        """
        self.assertEqual(list(mi.grouper("ABCDEF", 3)), [("A", "B", "C"), ("D", "E", "F")])
    ...
    def test_odd(self):
        ...
        """
        self.assertEqual(list(mi.grouper("ABCDE", 3)), [("A", "B", "C"), ("D", "E", None)])

    def test_fill_value(self):
        """Test that the fill value is used to pad the final group"""
        self.assertEqual(list(mi.grouper("ABCDE", 3, "x")), [("A", "B", "C"), ("D", "E", "x")])
...
class RoundrobinTests(TestCase):
    ...
    def test_even_groups(self):
        ...
        self.assertEqual(list(mi.roundrobin("ABC", [1, 2, 3], range(3))), ["A", 1, 0, "B", 2, 1, "C", 3, 2])

    def test_uneven_groups(self):
        """Ensure ordered output from unevenly populated iterables"""
        self.assertEqual(list(mi.roundrobin("ABCD", [1, 2], range(0))), ["A", 1, "B", 2, "C", "D"])
...
class PowersetTests(TestCase):
    ...
    def test_combinatorics(self):
        ...
        p = mi.powerset([1, 2, 3])
        self.assertEqual(list(p), [(), (1,), (2,), (3,), (1, 2), (1, 3), (2, 3), (1, 2, 3)])
