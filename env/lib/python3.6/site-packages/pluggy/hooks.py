    ...
    def __call__(self, function=None, firstresult=False, historic=False, warn_on_impl=None):
        ...
        def setattr_hookspec_opts(func):
            ...
            setattr(
                ...
                dict(firstresult=firstresult, historic=historic, warn_on_impl=warn_on_impl),
            )
            return func
    ...
    def __call__(self, function=None, hookwrapper=False, optionalhook=False, tryfirst=False, trylast=False):
        ...
        def setattr_hookimpl_opts(func):
            setattr(
                ...
                dict(hookwrapper=hookwrapper, optionalhook=optionalhook, tryfirst=tryfirst, trylast=trylast),
            )
            return func
...
class _HookCaller(object):
    ...
    def _add_hookimpl(self, hookimpl):
        ...
        if "__multicall__" in hookimpl.argnames:
            warnings.warn(
                "Support for __multicall__ is now deprecated and will be" "removed in an upcoming release.",
                DeprecationWarning,
            )
    ...
    def __call__(self, *args, **kwargs):
        ...
        if self.spec and self.spec.argnames:
            notincall = set(self.spec.argnames) - set(["__multicall__"]) - set(kwargs.keys())
            if notincall:
                warnings.warn(
    ...
    def call_historic(self, result_callback=None, kwargs=None, proc=None):
        ...
        if proc is not None:
            warnings.warn(
                "Support for `proc` argument is now deprecated and will be" "removed in an upcoming release.",
                DeprecationWarning,
            )
