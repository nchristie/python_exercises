    ...
    def cut(self, path=None, lineno=None, firstlineno=None, excludepath=None):
        ...
        for x in self:
            ...
            if (
                ...
                and (excludepath is None or not hasattr(codepath, "relto") or not codepath.relto(excludepath))
...
class ExceptionInfo(object):
    ...
    def getrepr(self, showlocals=False, style="long", abspath=False, tbfilter=True, funcargs=False):
        ...
        fmt = FormattedExcinfo(
            showlocals=showlocals, style=style, abspath=abspath, tbfilter=tbfilter, funcargs=funcargs
        )
