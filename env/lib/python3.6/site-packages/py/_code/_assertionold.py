...
class Compare(Interpretable):
    ...
    def eval(self, frame):
        ...
        for operation, expr2 in self.ops:
            ...
            expr2.eval(frame)
            self.explanation = "%s %s %s" % (expr.explanation, operation, expr2.explanation)
...
# == Unary operations ==
keepalive = []
for astclass, astpattern in {ast.Not: "not __exprinfo_expr", ast.Invert: "(~__exprinfo_expr)"}.items():
...
for astclass, astpattern in {
    ...
    class BinaryArith(Interpretable):
        ...
        def eval(self, frame, astpattern=astpattern):
            ...
            right.eval(frame)
            self.explanation = astpattern.replace("__exprinfo_left", left.explanation).replace(
                "__exprinfo_right", right.explanation
            )
            try:
