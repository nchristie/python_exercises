...
__all__ = ["samefile", "easy_install", "PthDistributions", "extract_wininst_cfg", "main", "get_exe_prefixes"]
...
class easy_install(Command):
    ...
    INSTALL_SCHEMES = dict(
        posix=dict(install_dir="$base/lib/python$py_version_short/site-packages", script_dir="$base/bin")
    )
