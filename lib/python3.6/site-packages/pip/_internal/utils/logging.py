    ...
    logging.config.dictConfig(
        {
            ...
            "filters": {
                "exclude_warnings": {"()": "pip._internal.utils.logging.MaxLevelFilter", "level": logging.WARNING}
            },
            "formatters": {"indent": {"()": IndentingFormatter, "format": "%(message)s"}},
            "handlers": {
                "console": {
                    "level": level,
            ...
            "root": {
                "level": root_level,
                "handlers": ["console", "console_errors"] + (["user_log"] if include_user_log else []),
            },
