    ...
    def _correct_build_location(self):
        ...
        if os.path.exists(new_location):
            raise InstallationError(
                "A package already exists in %s; please remove it to continue" % display_path(new_location)
            )
        logger.debug(
    ...
    def archive(self, build_dir):
        ...
        if os.path.exists(archive_path):
            response = ask_path_exists(
                "The file %s exists. (i)gnore, (w)ipe, (b)ackup, (a)bort " % display_path(archive_path),
                ("i", "w", "b", "a"),
            )
            if response == "i":
