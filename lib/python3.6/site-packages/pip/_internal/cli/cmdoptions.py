...
help_ = partial(Option, "-h", "--help", dest="help", action="help", help="Show help.")  # type: Any
...
def _merge_hash(option, opt_str, value, parser):
    ...
    try:
        ...
        parser.error(
            "Arguments to %s must be a hash name " "followed by a value, like --hash=sha256:abcde..." % opt_str
        )
...
index_group = {
    ...
    "options": [index_url, extra_index_url, no_index, find_links, process_dependency_links],
}
