...
_distributionImpl = {".egg": Distribution, ".egg-info": EggInfoDistribution, ".dist-info": DistInfoDistribution}
...
class Requirement(packaging.requirements.Requirement):
    def __init__(self, requirement_string):
        ...
        self.hashCmp = (self.key, self.specifier, frozenset(self.extras), str(self.marker) if self.marker else None)
